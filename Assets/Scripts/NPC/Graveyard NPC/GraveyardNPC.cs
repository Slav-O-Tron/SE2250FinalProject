...
public class GraveyardNPC : Entity
{
    [Header("Identity")]
    ...
    private DialogueLine[] RewardLines => new DialogueLine[]
    {
        ...
        {
            speakerName = npcName,
            text = "You have proven yourself worthy. The seal is broken."
        },
        new DialogueLine
        {
            speakerName = npcName,
    ...
    private DialogueLine[] ReminderLines => new DialogueLine[]
    {
        ...
        {
            speakerName = npcName,
            text = "The puzzle must be solved before I can give you what you seek."
        },
    };
    ...
    protected override void OnDeath()
    {
        ...
        if (failManager != null)
            ...
            Debug.LogError("[GraveyardNPC] No LevelFailManager found in scene.");
    }
}